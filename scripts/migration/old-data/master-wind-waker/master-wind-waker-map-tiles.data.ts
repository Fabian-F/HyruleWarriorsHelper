...
export const A2: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ["Hero's Clothes (Wind Waker) - Link", 'Deku Leaf Item Card'],
    treasure: [
...
export const B1: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Wind Waker) - Volga', 'Salvage Arm Item Card'],
    treasure: [
...
export const B6: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Hyoi Pear Item Card'],
    treasure: ['Piece of Heart - Medli (Central Keep)'],
    skulltulas: [
...
export const C1: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outift (Wind Waker) - Darunia', 'Wind Waker Item Card'],
    treasure: [
...
export const C4: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Wind Waker) - King Daphnes', 'Deku Leaf Item Card'],
    treasure: ['Heart Container - Wizzro (North Square)'],
    skulltulas: [
...
export const C6: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Salvage Arm Item Card'],
    treasure: ['Piece of Heart - Medli (South Square)', 'Fairy Food - Carrot (West Square [Pot])'],
  },
  requirements: {
    kills: 1200,
    minutes: 15,
...
export const D6: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Deku Leaf Item Card'],
    treasure: ['Fairy Food - Water Fruit (SE Sage Keep [Pot])'],
  },
  requirements: {
    kills: 1200,
    minutes: 15,
...
export const D7: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: undefined,
    treasure: ['Heart Container - Medli (South Field Keep)'],
  },
  requirements: {
    kills: 1600,
    minutes: 15,
...
export const E4: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Wind Waker) - Tingle', 'Hyoi Pear Item Card'],
    treasure: [
...
export const E7: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Wind Waker) - Ruto', 'Hookshot Item Card'],
    treasure: [
...
export const F2: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Sea Chart Item Card'],
    treasure: ['Piece of Heart - Medli (Stronghold)'],
    skulltulas: [
...
export const F7: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Wind Waker) - Tetra', 'Salvage Arm Item Card'],
    treasure: [
...
export const G1: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Wind Waker) - Toon Link', 'Deku Leaf Item Card'],
    treasure: [
...
export const I4: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Wind Waker) - Twili Midna', 'Salvage Arm Item Card'],
    treasure: [
...
export const I5: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Wind Waker) - Lana', 'Hyoi Pear Item Card'],
    treasure: [
...
export const I7: HWMapTile = {
  ...
  rewards: {
    arank: 'Heart Container - Young Link',
    clear: ['Deku Leaf Item Card'],
    treasure: ['Piece of Heart - Medli (South Field Keep)'],
    skulltulas: [
...
export const J4: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Wind Waker) - Sheik', 'Deku Leaf Item Card'],
    treasure: [
...
export const L1: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Robes (Wind Waker) - Zelda', 'Deku Leaf Item Card'],
    treasure: [
...
export const M4: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Wind Waker) - Fi', 'Hyoi Pear Item Card'],
    treasure: [
...
export const N3: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Wind Waker) - Midna', 'Hammer Item Card'],
    treasure: [
...
export const N5: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Wind Waker) - Ghirahim', 'Wind Waker Item Card'],
    treasure: ['Heart Container - Link (Eastern Room)'],
    skulltulas: [
