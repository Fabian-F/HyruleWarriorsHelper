...
export const A2: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Lorule) - Skull Kid', 'Tornado Rod Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const A4: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Lorule) - Zant', 'Baby Maiamai Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: 1200,
...
export const B8: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Lorule) - Ganondorf', 'Bomb Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const D3: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Lorule) - King Daphnes', 'Bow Item Card'],
    treasure: [
...
export const D7: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Lorule) - Tingle', 'Hammer Item Card'],
    treasure: [
...
export const F5: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Lorule) - Lana', 'Sand Rod Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const H3: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Lorule) - Midna', 'Boomerang Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const I7: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Lorule) - Fi', 'Bomb Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: 1200,
...
export const J1: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Lorule) - Agitha', 'Hookshot Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: 1200,
...
export const J4: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Lorule) - Ghirahim', 'Hookshot Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: 1200,
...
export const L8: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outift (Lorule) - Ruto', 'Power Glove Item Card'],
    treasure: undefined,
    skulltulas: [
...
export const M6: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Lorule) - Linkle', 'Bow Item Card'],
    treasure: [
...
export const O7: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Lorule) - Impa', 'Fire Rod Item Card'],
    treasure: [
...
export const P1: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Lorule) - Darunia', 'Ice Rod Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: 1600,
...
export const P3: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Lorule) - Twili Midna', 'Tornado Rod Item Card'],
    treasure: [
...
export const P4: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Lorule) - Young Link', 'Ice Rod Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: 1600,
