...
export const A1: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: undefined,
    treasure: ['Heart Container - Link (W. Rockface Keep)'],
    skulltulas: [
...
export const A4: HWMapTile = {
  ...
  rewards: {
    ...
    clear: undefined,
    treasure: ['Heart Container - Ghirahim (West Keep)', 'Fairy Top - Skyloft Shirt (West Ruins)'],
  },
  requirements: {
    kills: 1200,
    minutes: 15,
...
export const A8: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Master Quest) - Ganondorf', 'Compass Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: 1600,
...
export const B2: HWMapTile = {
  ...
  rewards: {
    ...
    clear: undefined,
    treasure: ['Heart Container - Cia (Central Chamber)'],
  },
  requirements: {
    kills: 1600,
    minutes: 15,
...
export const B5: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Guardian of Time - Lana', "Goddess's Harp Item Card"],
    treasure: undefined,
    skulltulas: [
...
export const B6: HWMapTile = {
  ...
  rewards: {
    ...
    treasure: ['Heart Container - Tetra (Abandoned Fort)'],
  },
  requirements: {
    kills: 1600,
    minutes: 15,
...
export const B8: HWMapTile = {
  ...
  rewards: {
    ...
    clear: undefined,
    treasure: ['Heart Container - Young Link (W. Boulder Keep)'],
  },
  requirements: {
    kills: 1600,
    minutes: undefined,
...
export const E3: HWMapTile = {
  ...
  rewards: {
    ...
    treasure: ['Fairy Food - Life Tree Fruit (Southwest Keep [Pot])'],
  },
  requirements: {
    kills: 1200,
    minutes: 15,
...
export const E4: HWMapTile = {
  ...
  rewards: {
    ...
    clear: undefined,
    treasure: ['Heart Container - Skull Kid (West Temple)'],
    skulltulas: [
...
export const E7: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Power Bracelet Item Card'],
    treasure: ['Fairy Top - Skyloft Shirt (East Temple Hall)'],
  },
  requirements: {
    kills: 1600,
    minutes: 15,
...
export const F2: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Bomb Item Card'],
    treasure: ['Heart Container - Lana (Town Center Keep)'],
  },
  requirements: {
    kills: 1600,
    minutes: 15,
...
export const F4: HWMapTile = {
  ...
  rewards: {
    ...
    treasure: ['Heart Container - Fi (West Town Keep)'],
    skulltulas: [
...
export const F7: HWMapTile = {
  ...
  rewards: {
    ...
    clear: undefined,
    treasure: ['Fairy Top - Skyloft Shawl (Central Keep)'],
  },
  requirements: {
    kills: 1600,
    minutes: 15,
...
export const G1: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ["Goddess's Harp Item Card"],
    treasure: ['Heart Container - Sheik (Southwest Keep)'],
  },
  requirements: {
    kills: 1600,
    minutes: 15,
...
export const J2: HWMapTile = {
  ...
  rewards: {
    ...
    clear: undefined,
    treasure: ['Fairy Top - Outset Shirt (North Field Keep)'],
  },
  requirements: {
    kills: 1600,
    minutes: 15,
...
export const J7: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ["Goddess's Harp Item Card"],
    treasure: ['Fairy Top - Skyloft Shirt (North Palace)'],
  },
  requirements: {
    kills: 1200,
    minutes: 15,
...
export const J8: HWMapTile = {
  ...
  rewards: {
    arank: 'Heart Container - Zelda',
    clear: ['Ice Arrow Item Card'],
    treasure: ['Fairy Bottom - Skyloft Slacks (Rockface Keep)'],
  },
  requirements: {
    kills: 1600,
    minutes: 15,
...
export const K1: HWMapTile = {
  ...
  rewards: {
    ...
    clear: undefined,
    treasure: ['Heart Container - Link (Mountain Keep)'],
  },
  requirements: {
    kills: 1200,
    minutes: 15,
...
export const K6: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Master Quest) - Agitha', 'Power Bracelet Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const L1: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ["Goddess's Harp Item Card"],
    treasure: ['Fairy Top - Skyloft Apron (West Ruins)'],
  },
  requirements: {
    kills: 1200,
    minutes: 15,
...
export const L6: HWMapTile = {
  ...
  rewards: {
    ...
    clear: undefined,
    treasure: ['Fairy Top - Skyloft Shawl (Fairy Fountain)'],
  },
  requirements: {
    kills: 1200,
    minutes: 15,
...
export const M2: HWMapTile = {
  ...
  rewards: {
    arank: 'Heart Container - Young Link',
    clear: ['Hookshot Item Card'],
    treasure: ['Piece of Heart - Wizzro (East Keep)', 'Fairy Top - Skyloft Shirt (West Ruins)'],
  },
  requirements: {
    kills: undefined,
    minutes: 15,
...
export const M4: HWMapTile = {
  ...
  rewards: {
    ...
    clear: undefined,
    treasure: ['Fairy Food - Life Tree Fruit (Enemy Base [Pot])'],
  },
  requirements: {
    kills: 1200,
    minutes: 15,
...
export const N5: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Compass Item Card'],
    treasure: ['My Fairy - Fire (W. Boulder Keep [Pot])', 'Fairy Food - Pumpkin (East Keep [Pot])'],
  },
  requirements: {
    kills: 1200,
    minutes: 15,
...
export const O3: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Water Bomb Item Card'],
    treasure: ['Fairy Accessory - Demon Lord Earrings (Mountain Keep)'],
  },
  requirements: {
    kills: 1600,
    minutes: 15,
...
export const O4: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Compass Item Card'],
    treasure: ['Heart Container - Agitha (West Town Keep)'],
  },
  requirements: {
    kills: 1600,
    minutes: 15,
...
export const O6: HWMapTile = {
  ...
  rewards: {
    ...
    clear: undefined,
    treasure: ['Fairy Bottom - Skyloft Slacks (Hilltop Keep)'],
  },
  requirements: {
    kills: undefined,
    minutes: 15,
...
export const O8: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Guardian of Time - Cia', "Goddess's Harp Item Card"],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const P1: HWMapTile = {
  ...
  rewards: {
    ...
    clear: undefined,
    treasure: ['Heart Container - Twili Midna (Lakeside Keep)'],
  },
  requirements: {
    kills: 1200,
    minutes: 15,
...
export const P2: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Water Bomb Item Card'],
    treasure: ['Fairy Top - Skyloft Apron (W. Boulder Keep)'],
  },
  requirements: {
    kills: undefined,
    minutes: 15,
...
export const P3: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Robes (Master Quest) - Zelda', 'Compass Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: 1600,
...
export const P4: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Compass Item Card'],
    treasure: ['Fairy Top - Demon Lord Shirt (N. Settlement)'],
  },
  requirements: {
    kills: 1600,
    minutes: 15,
...
export const P7: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Compass Item Card'],
    treasure: ['Fairy Bottom - Skyloft Skirt (Northeast Keep)'],
  },
  requirements: {
    kills: 1600,
    minutes: 15,
