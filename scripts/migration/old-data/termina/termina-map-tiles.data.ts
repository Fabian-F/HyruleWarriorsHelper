...
import { OldTile as Tile } from '../old-models';
...
export const A3: HWMapTile = {
  ...
  rewards: {
    ...
    treasure: ['Heart Container - Sheik (Fairy Fountain)'],
    skulltulas: [
...
export const B3: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Fierce Diety Link Costume - Link', "Majora's Mask Item Card", 'Goron Mask Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const D7: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Giant Item Card', 'Deku Stick Item Card'],
    treasure: undefined,
    skulltulas: [
...
export const E4: HWMapTile = {
  ...
  rewards: {
    ...
    clear: undefined,
    treasure: ['My Fairy - Water (West Keep)', 'Fairy Food - Bottled Water (East Keep [Pot])'],
  },
  requirements: {
    kills: 1200,
    minutes: 15,
...
export const E5: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Mask of Truth Item Card', 'Bomb Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const F7: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Kokiri Tunic Costume - Link', 'Zora Mask Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const G1: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Giant Item Card', 'Goron Mask Item Card'],
    treasure: ['Heart Container - Wizzro (Fairy Fountain)'],
    skulltulas: [
...
export const G2: HWMapTile = {
  ...
  blockades: [Blockade.EAST, Blockade.SOUTH, Blockade.WEST],
  search: [
    {
      item: Items.ICEARROW,
      target: {
...
export const G5: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Stone Mask Costume - Fi', 'Compass Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: 3,
...
export const H2: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ["Troupe Leader's Mask Costume - Zant", 'Deku Mask Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: 1200,
...
export const H4: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ["Majora's Mask Item Card", 'Ice Arrow Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const H6: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ["Majora's Mask Costume - Cia", 'Bomb Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const I5: HWMapTile = {
  ...
  rewards: {
    ...
    treasure: ['Fairy Bottom - Balloon Shorts (North Oasis)'],
  },
  requirements: {
    kills: 1000,
    minutes: 15,
...
export const I7: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Song of Time Item Card', 'Bomb Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const I8: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Era of the Hero of Time Outfit - Sheik', 'Mask of Truth Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const J2: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Goron Mask Costume - Darunia', 'Compass Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: 3,
...
export const J7: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Zora Mask Costume - Ruto', 'Bomb Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const K1: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Mask of Truth Costume - Impa', 'Inverted Song of Time Item Card', 'Compass Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const K3: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ["Don Gero's Mask Costume - Agitha", 'Mask of Truth Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const K7: HWMapTile = {
  ...
  rewards: {
    ...
    clear: undefined,
    treasure: ['My Fairy - Fire (East Goron Keep)', 'Fairy Food - Ember Seeds (East Keep [Pot])'],
  },
  requirements: {
    kills: 1200,
    minutes: 15,
...
export const L3: HWMapTile = {
  ...
  rewards: {
    arank: 'Heart Container - Tingle',
    clear: ['Inverted Song of Time Item Card', 'Compass Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const L4: HWMapTile = {
  ...
  rewards: {
    arank: 'Heart Container - Skull Kid',
    clear: ["Majora's Mask Item Card", 'Compass Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const L8: HWMapTile = {
  ...
  rewards: {
    arank: 'Heart Container - Zant',
    clear: ['Giant Item Card', 'Deku Mask Item Card'],
    treasure: undefined,
    skulltulas: [
      'KO 1000 enemies. Located along the north wall of the large open area north of West Square.',
...
export const M1: HWMapTile = {
  ...
  rewards: {
    arank: 'Heart Container - Young Link',
    clear: ['Goron Mask Item Card'],
    treasure: ['Piece of Heart - Link (Central Square)'],
    skulltulas: [
...
export const M2: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Ordon Shield Costume - Midna', 'Inverted Song of Time Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const M5: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Era of the Hero of Time Robes - Zelda', "Majora's Mask Item Card"],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const M6: HWMapTile = {
  ...
  rewards: {
    ...
    clear: undefined,
    treasure: ['Fairy Food - Bottled Water (Fairy Fountain [Pot])'],
  },
  requirements: {
    kills: 1200,
    minutes: 15,
...
export const M7: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ["Kafei's Mask Costume - Sheik", 'Inverted Song of Time Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const N3: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ["Giant's Mask Costume - Volga", 'Inverted Song of Time Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const N5: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ["Kamaro's Mask Costume - Ghirahim", 'Deku Stick Item Card'],
    treasure: [
