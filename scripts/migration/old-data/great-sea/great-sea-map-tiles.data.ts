import {
  OldDifficulty as Difficulty,
  OldBlockade as Blockade,
  OldMapTile as HWMapTile,
} from '../old-models';
...
export const A3: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Boomerang Item Card'],
    treasure: ['Heart Container - Link (E. Boulder Keep)'],
    skulltulas: [
...
export const A4: HWMapTile = {
  ...
  rewards: {
    ...
    treasure: ['Heart Container - Twili Midna (South Mine Keep)'],
    skulltulas: [
...
export const B7: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Great Sea) - Agitha', "Hero's Bow Item Card"],
    treasure: undefined,
  },
  requirements: {
    kills: 3,
...
export const C2: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Wind Waker Item Card'],
    treasure: ['Piece of Heart - Link (West Keep)', 'Fairy Top - Wind Robe (W. Boulder Keep)'],
  },
  requirements: {
    kills: 1200,
    minutes: 15,
...
export const C3: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Great Sea) - Zant', 'Compass Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: 1200,
...
export const C6: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Great Sea) - Linkle', 'Deku Leaf Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const D1: HWMapTile = {
  ...
  rewards: {
    ...
    treasure: ['Heart Container - Lana (NW Sage Keep)'],
    skulltulas: [
...
export const D4: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ["Hero's Bow Item Card"],
    treasure: ['Heart Container - Ruto (E. Mountain Keep)'],
    skulltulas: [
...
export const D5: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Great Sea) - Wizzro', 'Cannon Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: 1200,
...
export const D7: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Great Sea) - Toon Link', 'Boomerang Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const E2: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Wind Waker Item Card'],
    treasure: ['Heart Container - Tingle (Hall of Time)'],
    skulltulas: [
...
export const F2: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Great Sea) - Midna', 'Power Bracelet Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const F4: HWMapTile = {
  ...
  rewards: {
    ...
    clear: undefined,
    treasure: ['Heart Container - Skull Kid (W. Boulder Keep)'],
    skulltulas: [
...
export const F5: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Great Sea) - Darunia', 'Salvage Arm Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: 1200,
...
export const F7: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Hyoi Pear Item Card'],
    treasure: ['Heart Container - Wizzro (Lakeside Keep)'],
    skulltulas: [
...
export const G2: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Great Sea) - Fi', 'Salvage Arm Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const G4: HWMapTile = {
  ...
  blockades: [Blockade.WEST, Blockade.EAST],
  search: [],
};
...
export const H3: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Great Sea) - King Daphnes', 'Hookshot Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const H4: HWMapTile = {
  ...
  rewards: {
    ...
    clear: undefined,
    treasure: ['Piece of Heart - Toon Link (Rock Keep)'],
    skulltulas: [
...
export const H5: HWMapTile = {
  ...
  rewards: {
    arank: 'Heart Container - King Daphnes',
    clear: undefined,
    treasure: ['Piece of Heart - King Daphnes (N. Entrance Keep)'],
    skulltulas: [
...
export const I4: HWMapTile = {
  ...
  rewards: {
    ...
    clear: undefined,
    treasure: ['Heart Container - Young Link (S. Entrance Keep)'],
    skulltulas: [
...
export const I5: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Great Sea) - Ganondorf', 'Salvage Arm Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const I7: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Great Sea) - Young Link', 'Compass Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: 3,
...
export const J1: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Great Sea) - Impa', 'Hyoi Pear Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const J3: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Great Sea) - Tingle', "Hero's Bow Item Card"],
    treasure: undefined,
  },
  requirements: {
    kills: 3,
...
export const J4: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Deku Leaf Item Card'],
    treasure: ['Heart Container - Midna (West Temple)', 'My Fairy - Water (Ruins Summit [Pot])'],
  },
  requirements: {
    kills: 1000,
    minutes: 15,
...
export const J5: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Salvage Arm Item Card'],
    treasure: ['Heart Container - Darunia (Mountain Keep)'],
    skulltulas: [
...
export const J6: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Great Sea) - Lana', "Hero's Bow Item Card"],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const K1: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Salvage Arm Item Card'],
    treasure: ['Heart Container - Agitha (School of Joy)'],
    skulltulas: [
...
export const K4: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Great Sea) - Ruto', 'Cannon Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const L1: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ["Hero's Clothes (Great Sea) - Link", 'Hyoi Pear Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const L2: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Great Sea) - Volga', 'Hyoi Pear Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: 1000,
...
export const M1: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Robes (Great Sea) - Zelda', 'Salvage Arm Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: 1000,
...
export const M2: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Wind Waker Item Card'],
    treasure: ['Heart Container - Zelda (Stock Room)', 'Fairy Headwear - Rito Mask (South Square)'],
  },
  requirements: {
    kills: 1000,
    minutes: 15,
...
export const M7: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Great Sea) - Skull Kid', 'Compass Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const N1: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Hyoi Pear Item Card'],
    treasure: ['Piece of Heart - Lana (West Square)'],
    skulltulas: [
...
export const N2: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Great Sea) - Ghirahim', 'Hyoi Pear Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const N4: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Deku Leaf Item Card'],
    treasure: ["Heart Container - Cia (Glutton's Keep)"],
    skulltulas: [
...
export const N5: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Great Sea) - Twili Midna', 'Compass Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const N7: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Deku Leaf Item Card'],
    treasure: ["Heart Container - Impa (Glutton's Keep)"],
    skulltulas: [
