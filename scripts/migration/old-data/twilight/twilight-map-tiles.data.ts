...
export const B5: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Era of Twilight Robes - Zelda', 'Ooccoo Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const B6: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Masked (Twilight) - Cia', 'Unmasked (Twilight) - Cia', 'Hatless (Twilight) - Cia'],
    treasure: ['Heart Container - Impa (South Garden)'],
    skulltulas: [
...
export const B7: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Jar Item Card', 'Tears of Light Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const C4: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Tears of Light Item Card', 'Compass Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const C6: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ["Hero's Clothes (Twilight) - Link", 'Fishing Rod Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const C8: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Tears of Light Item Card', 'Lantern Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const D7: HWMapTile = {
  ...
  rewards: {
    ...
    treasure: ['Heart Container - Cia (E. Mountain Keep)'],
    skulltulas: [
...
export const E1: HWMapTile = {
  ...
  rewards: {
    ...
    treasure: ['Heart Container - Ghirahim (S. Rockface Keep)'],
    skulltulas: [
...
export const E3: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Tears of Light Item Card', 'Fishing Rod Item Card'],
    treasure: [
...
export const E5: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: undefined,
    treasure: ['Heart Container - Sheik (Mountain Keep)'],
    skulltulas: [
...
export const F2: HWMapTile = {
  ...
  rewards: {
    ...
    treasure: ['Heart Container - Fi (N. Rockface Keep)'],
    skulltulas: [
...
export const G4: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Tears of Light Item Card', 'Bomb Item Card'],
    treasure: [
...
export const G6: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Postman Uniform - Link', 'Bomb Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const H3: HWMapTile = {
  ...
  rewards: {
    ...
    treasure: ['Heart Container - Zant (Exit Square)'],
    skulltulas: [
...
export const I3: HWMapTile = {
  ...
  rewards: {
    arank: 'Heart Container - Young Link',
    clear: ['Tears of Light Item Card', 'Jar Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const I4: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Era of Twilight Armor - Ganondorf', 'Tears of Light Item Card', 'Spinner Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const I6: HWMapTile = {
  ...
  rewards: {
    arank: 'Heart Container - Ghirahim',
    clear: ['Clawshot Item Card'],
    treasure: ["Fairy Bottom - Hero's Trousers (W. Mountain Keep)"],
  },
  requirements: {
    kills: 1200,
    minutes: 15,
...
export const J1: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Twilight) - Agitha', 'Spinner Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const J4: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Tears of Light Item Card', 'Water Bomb Item Card'],
    treasure: ['Heart Container - Zelda (East Room)', 'Fairy Top - Twilight Top (Lakeside Keep)'],
  },
  requirements: {
    kills: 1600,
    minutes: 15,
...
export const J6: HWMapTile = {
  ...
  rewards: {
    ...
    treasure: ['Heart Container - Wizzro (Stock Room)'],
    skulltulas: [
...
export const K2: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Twilight) - Impa', 'Tears of Light Item Card', 'Lantern Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const K3: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Twilight) - Zelda', 'Ooccoo Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const K4: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Tears of Light Item Card', 'Digging Mitts Item Card'],
    treasure: undefined,
    skulltulas: [
...
export const K7: HWMapTile = {
  ...
  rewards: {
    arank: 'Heart Container - Tetra',
    clear: ['Tears of Light Item Card', 'Spinner Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: 1200,
...
export const L4: HWMapTile = {
  ...
  rewards: {
    arank: 'Heart Container - Cia',
    clear: undefined,
    treasure: ['Fairy Bottom - Magic Skirt (Upper Level East)'],
  },
  requirements: {
    kills: 1600,
    minutes: 15,
...
export const L5: HWMapTile = {
  ...
  rewards: {
    ...
    treasure: ['Heart Container - Lana (East Temple)'],
    skulltulas: [
...
export const N4: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ["Ilia's Clothes - Zelda", 'Jar Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const N6: HWMapTile = {
  ...
  rewards: {
    ...
    clear: undefined,
    treasure: ["Fairy Top - Hero's Clothes (South Field Keep)"],
  },
  requirements: {
    kills: 1000,
    minutes: 15,
