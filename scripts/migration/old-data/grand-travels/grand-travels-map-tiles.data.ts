...
export const A4: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Grand Travels) - Impa', 'Steel Train Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const A6: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Grand Travels) - Ganondorf', 'Cannon Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const B2: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Grand Travels) - Linkle', 'Railway Track Item Card'],
...
export const B8: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Grand Travels) - Young Link', 'Spirit Train Item Card'],
    treasure: [
...
export const D3: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Grand Travels) - Darunia', 'Compass Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const E2: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Grand Travels) - Volga', 'Whirlwind Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: 1600,
...
export const E5: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Grand Travels) - Toon Link', 'Cannon Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const G4: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ["Hero's Clothes (Grand Travels) - Link", 'Whirlwind Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const G7: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Grand Travels) - Tetra', 'Compass Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const I6: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Grand Travels) - Ruto', 'Fishing Rod Item Card'],
...
export const I7: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Cannon Item Card'],
    treasure: ['My Fairy - Water (Eastern Tree)', 'Fairy Food - Hyoi Pear (Eastern Tree [Pot])'],
  },
  requirements: {
    kills: 1200,
    minutes: 15,
...
export const J1: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Grand Travels) - Wizzro', 'Cannon Item Card'],
    treasure: [
...
export const J5: HWMapTile = {
  ...
  rewards: {
    ...
    clear: ['Compass Item Card'],
    treasure: ['Heart Container - Link (East Room)', 'Fairy Food - Rock Sirloin (West Room [Pot])'],
  },
  requirements: {
    kills: 1600,
    minutes: 15,
...
export const J8: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Grand Travels) - Fi', 'Cyclone Slate Item Card'],
    treasure: [
...
export const L4: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Grand Travels) - Tingle', 'Compass Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const M7: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Grand Travels) - Twili Midna', 'Compass Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const N3: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Grand Travels) - Zelda', 'Compass Item Card'],
    treasure: [
...
export const N5: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Grand Travels) - Skull Kid', 'Compass Item Card'],
...
export const P6: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Grand Travels) - King Daphnes', 'S.S. Linebeck Item Card'],
    treasure: [
