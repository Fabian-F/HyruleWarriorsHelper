...
export const A3: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Koholint) - Toon Link', 'Power Bracelet Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const A6: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outift (Koholint) - Zant', 'Compass Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const B2: HWMapTile = {
  ...
  rewards: {
    ...
    treasure: ['Heart Container - King Daphnes (South Mine Keep)'],
    skulltulas: [
...
export const C5: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Marin', 'Grandpa Ulrira Item Card'],
    treasure: undefined,
  },
  requirements: {
    kills: undefined,
...
export const E1: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Koholint) - Agitha', 'Magic Powder Item Card'],
...
export const E5: HWMapTile = {
  ...
  rewards: {
    ...
    clear: undefined,
    treasure: ['Heart Container - Tetra (Mine Keep)'],
    skulltulas: [
...
export const E6: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Koholint) - Wizzro', 'Full Moon Cello Item Card'],
    treasure: [
...
export const F1: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ["Hero's Clothes (Koholint) - Link", 'Thunder Drum Item Card'],
    treasure: [
...
export const G3: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Koholint) - Young Link', 'Grandpa Ulrira Item Card'],
    treasure: [
...
export const H1: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Robes (Koholint) - Zelda', 'Compass Item Card'],
    treasure: ['Heart Container - Marin (Lakeside Keep)'],
    skulltulas: [
...
export const I3: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Koholint) - Ghirahim', 'Grandpa Ulrira Item Card'],
    treasure: [
...
export const I6: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Koholint) - Tetra', 'Wind Marimba Item Card'],
    treasure: [
...
export const L6: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Koholint) - Skull Kid', 'Power Bracelet Item Card'],
...
export const M1: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Koholint) - Linkle', 'Organ of Evening Calm Item Card'],
    treasure: [
...
export const N3: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Koholint) - Ganondorf', 'Power Bracelet Item Card'],
    treasure: ['Heart Container - Marin (W. Rockface Keep)'],
    skulltulas: [
...
export const N5: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Koholint) - Sheik', 'Wind Marimba Item Card'],
    treasure: [
...
export const N6: HWMapTile = {
  ...
  rewards: {
    arank: undefined,
    clear: ['Standard Outfit (Koholint) - Tingle', 'Grandpa Ulrira Item Card'],
    treasure: ['Heart Container - Tingle (Southwest Keep)'],
    skulltulas: [
